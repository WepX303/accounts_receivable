            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-3">
                        <div>
                            <h4 class="mb-1">Daily Cash Closing Report</h4>
                            <p class="text-muted mb-0">
                                Daily cash closing totals by cash, card, phone, change and net collection.
                            </p>
                        </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">Daily Cash Closing Totals</h5>
                </div>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="8" class="text-center text-muted py-4">
                                            No daily cash closing data found.
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
