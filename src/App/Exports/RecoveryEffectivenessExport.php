...
class RecoveryEffectivenessExport implements FromCollection, WithHeadings, ShouldAutoSize, WithStyles
{
    ...
    public function headings(): array
    {
        return [
            ...
            __('pages/reports.recovery_effectiveness.gross_recovered'),
            __('pages/reports.common.change_returned'),
            __('pages/reports.recovery_effectiveness.net_recovered'),
            __('pages/reports.recovery_effectiveness.recovery_percent'),
            __('pages/reports.common.last_payment'),
